...
class Form extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <h3 className="text-center text-bold">POST YOUR ADD</h3>
                <div className="card m-auto" style={{width: '35rem'}}>
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item">
                            ...
                            <input type="text" placeholder="Product Name" className="form-control border-secondary"/>
                            <label>Description</label>
                            <textarea type="text" placeholder="Product Details..." className="form-control border-secondary"/>
                        </li>
                        <li className="list-group-item">
                            <h5>SET A PRICE</h5>
                        ...
                        <li className="list-group-item">
                            ...
                            <div className="d-flex">
                                <div className="card m-2" style={{width: '8rem'}}>
                                    ...
                                    <input type="file" className="border-0 file" onChange={this.changeHandler} />
